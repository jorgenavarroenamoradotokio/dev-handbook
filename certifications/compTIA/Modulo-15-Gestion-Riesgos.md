...
- [2. Identificación y Evaluación de Riesgos](#2-identificación-y-evaluación-de-riesgos)
  - [Tipos de evaluaciones de riesgos](#tipos-de-evaluaciones-de-riesgos)
  - [Análisis cuantitativo vs. cualitativo](#análisis-cuantitativo-vs-cualitativo)
  ...
  - [Clasificación FIPS 199](#clasificación-fips-199)
- [3. Estrategias de Respuesta al Riesgo](#3-estrategias-de-respuesta-al-riesgo)
  - [Excepción vs. exención de riesgo](#excepción-vs-exención-de-riesgo)
  - [Riesgo residual vs. apetito por el riesgo](#riesgo-residual-vs-apetito-por-el-riesgo)
- [4. Procesos y Herramientas de Gestión de Riesgos](#4-procesos-y-herramientas-de-gestión-de-riesgos)
  - [Las 5 fases del proceso de gestión de riesgos](#las-5-fases-del-proceso-de-gestión-de-riesgos)
  - [Marcos de referencia](#marcos-de-referencia)
  - [RCSA vs. RCA](#rcsa-vs-rca)
  - [Registro de riesgos](#registro-de-riesgos)
  - [Indicadores clave de riesgo (KRI)](#indicadores-clave-de-riesgo-kri)
  - [Niveles de apetito por el riesgo](#niveles-de-apetito-por-el-riesgo)
- [5. Análisis de Impacto Empresarial (BIA)](#5-análisis-de-impacto-empresarial-bia)
  - [Identificación de sistemas críticos](#identificación-de-sistemas-críticos)
  - [MEF vs. PBF](#mef-vs-pbf)
  - [Las métricas clave del BIA](#las-métricas-clave-del-bia)
  - [MTBF y MTTR](#mtbf-y-mttr)
- [6. Gestión de Proveedores y Terceros](#6-gestión-de-proveedores-y-terceros)
  - [Por qué importa la evaluación de terceros](#por-qué-importa-la-evaluación-de-terceros)
  - [Proceso de selección de proveedores](#proceso-de-selección-de-proveedores)
  - [Conflictos de interés en proveedores](#conflictos-de-interés-en-proveedores)
  - [Métodos de evaluación de proveedores](#métodos-de-evaluación-de-proveedores)
  - [Monitoreo continuo de proveedores](#monitoreo-continuo-de-proveedores)
- [7. Acuerdos Legales con Proveedores](#7-acuerdos-legales-con-proveedores)
  - [Acuerdos iniciales (marco de relación)](#acuerdos-iniciales-marco-de-relación)
  - [Acuerdos operativos detallados](#acuerdos-operativos-detallados)
  - [Reglas de Intervención (RoE)](#reglas-de-intervención-roe)
- [8. Auditorías y Evaluaciones](#8-auditorías-y-evaluaciones)
  - [Diferencia entre auditoría y evaluación](#diferencia-entre-auditoría-y-evaluación)
  - [Evaluaciones internas vs. externas](#evaluaciones-internas-vs-externas)
    - [Evaluaciones internas](#evaluaciones-internas)
    - [Evaluaciones externas](#evaluaciones-externas)
  - [Valor combinado: interno + externo](#valor-combinado-interno--externo)
- [9. Pruebas de Penetración](#9-pruebas-de-penetración)
  - [¿Qué es un pen test?](#qué-es-un-pen-test)
  - [Fases de una prueba de penetración](#fases-de-una-prueba-de-penetración)
  - [Reconocimiento activo vs. pasivo](#reconocimiento-activo-vs-pasivo)
  - [Métodos por conocimiento previo (White/Grey/Black box)](#métodos-por-conocimiento-previo-whitegreyblack-box)
- [10. Tipos de Ejercicios de Pentest](#10-tipos-de-ejercicios-de-pentest)
  - [Red Team vs. Blue Team vs. Purple Team](#red-team-vs-blue-team-vs-purple-team)
  - [Pruebas de penetración física](#pruebas-de-penetración-física)
  - [Pruebas integradas y continuas](#pruebas-integradas-y-continuas)
...
## Excepción vs. exención de riesgo
...
## Riesgo residual vs. apetito por el riesgo
...
## Las 5 fases del proceso de gestión de riesgos
...
## Por qué importa la evaluación de terceros
...
## Conflictos de interés en proveedores
...
## Acuerdos iniciales (marco de relación)
...
## Acuerdos operativos detallados
...
## Evaluaciones internas vs. externas
...
## Valor combinado: interno + externo
...
## Métodos por conocimiento previo (White/Grey/Black box)
...
## Pruebas integradas y continuas
