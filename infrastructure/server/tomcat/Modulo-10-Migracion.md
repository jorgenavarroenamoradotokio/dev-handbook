...
- [Módulo 10: Migración entre Versiones (8.0 → 8.5 → 9 → 10 → 11)](#módulo-10-migración-entre-versiones-80--85--9--10--11)
  - [10.1 Visión General del Mapa de Migración](#101-visión-general-del-mapa-de-migración)
    - [Tabla de compatibilidad completa](#tabla-de-compatibilidad-completa)
  - [10.2 Migración de Tomcat 8.0 a Tomcat 8.5](#102-migración-de-tomcat-80-a-tomcat-85)
    - [10.2.1 Cambios principales](#1021-cambios-principales)
    - [10.2.2 Checklist de migración 8.0 → 8.5](#1022-checklist-de-migración-80--85)
    - [10.2.3 Cambios en server.xml para 8.5](#1023-cambios-en-serverxml-para-85)
  - [10.3 Migración de Tomcat 8.5 a Tomcat 9.0](#103-migración-de-tomcat-85-a-tomcat-90)
    - [10.3.1 Cambios principales](#1031-cambios-principales)
    - [10.3.2 Checklist de migración 8.5 → 9.0](#1032-checklist-de-migración-85--90)
    - [10.3.3 Cambios en configuración para Tomcat 9.0](#1033-cambios-en-configuración-para-tomcat-90)
  ...
  - [10.5 Migración de Tomcat 10.0 a Tomcat 10.1](#105-migración-de-tomcat-100-a-tomcat-101)
    - [10.5.1 Cambios principales](#1051-cambios-principales)
    - [10.5.2 Checklist de migración 10.0 → 10.1](#1052-checklist-de-migración-100--101)
  - [10.6 Migración de Tomcat 10.1 a Tomcat 11.0](#106-migración-de-tomcat-101-a-tomcat-110)
    - [10.6.1 Cambios principales](#1061-cambios-principales)
    - [10.6.2 Adopción de Virtual Threads en Tomcat 11](#1062-adopción-de-virtual-threads-en-tomcat-11)
  ...
  - [10.9 Tabla Maestra de Cambios por Versión](#109-tabla-maestra-de-cambios-por-versión)
    - [Cambios de configuración acumulados](#cambios-de-configuración-acumulados)
